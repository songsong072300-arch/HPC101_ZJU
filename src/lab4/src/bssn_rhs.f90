...
!!!!!!!!!advection term part + Kreiss-Oliger dissipation (combined)
  ...
  if(eps>0)then
! usual Kreiss-Oliger dissipation for gxx(=dxx+1), gyy(=dyy+1), gzz(=dzz+1)
! these use dxx/dyy/dzz (not gxx/gyy/gzz) so cannot combine with lopsided
